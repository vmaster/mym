													...
													<tr>
														...
														<td>
															<select class="form-control select_re_epp" name= "data[Acta][cumplimiento_epp][<?php echo $i; ?>][incidencia]">
																<option value="4" <?php echo (isset($info_des_act->incidencia) && $info_des_act->incidencia == 4)?"selected":""?>>--</option>
																<option value="3" <?php echo (isset($info_des_act->incidencia) && $info_des_act->incidencia == 3)?"selected":""?>>N - Nueva Insp./Obs.</option>
																<option value="2" <?php echo (isset($info_des_act->incidencia) && $info_des_act->incidencia == 2)?"selected":""?>>S - Subsanado</option>
																<option value="1" <?php echo (isset($info_des_act->incidencia) && $info_des_act->incidencia == 1)?"selected":""?>>R - Reiterativo</option>
								...
								<tbody>
									<tr>
										...
										<div class="fileupload" data-type="FotoSupervisionActa">
											...
											<table role="presentation" class="table table-striped">
																<tbody class="files">
																<?php foreach($obj_acta->FotoSupervisionActa as $key => $obj_foto_acta) {?> 
																<?php $file_name =$obj_foto_acta->getAttr('file_name'); $file_name_explode =explode('.', $file_name);?>
																	<tr class="template-download fade in" foto-acta="<?php echo $file_name_explode[0];?>">
																		<td><span class="preview"> <a
																				href="<?= ENV_WEBROOT_FULL_URL; ?>files/fotos_acta_supervision/<?php echo $obj_foto_acta->getAttr('file_name'); ?>"
																				title="<?php echo $obj_foto_acta->getAttr('file_name'); ?>" download="b. precios  maestrias soles.png"
																				data-gallery=""><img src="<?= ENV_WEBROOT_FULL_URL; ?>files/fotos_acta_supervision/thumbnail/<?php echo $obj_foto_acta->getAttr('file_name'); ?>" width='80px'>
																			</a>
																			<textarea rows="3"  name="data[FotoSupActaUpdate][<?php echo $key; ?>][Observacion][]" placeholder="Observaci&oacute;n"><?php echo $obj_foto_acta->getAttr('observacion'); ?></textarea>
																			<input type="hidden" value="<?php echo $obj_foto_acta->getAttr('id'); ?>" name="data[FotoSupActaUpdate][<?php echo $key; ?>][id][]">
																		</span>
																		</td>
																		<td>
																			<p class="name">
																				<a href="<?= ENV_WEBROOT_FULL_URL; ?>files/fotos_acta_supervision/<?php echo $obj_foto_acta->getAttr('file_name'); ?>"
																		...
																		<td>
																			...
																			<a href="<?= ENV_WEBROOT_FULL_URL; ?>files/fotos_acta_supervision/<?php echo $obj_foto_acta->getAttr('file_name'); ?>" title="<?php echo $obj_foto_acta->getAttr('file_name'); ?>" download="<?php echo $obj_foto_acta->getAttr('file_name'); ?>" class="btn btn-default">
																					<i class="fa fa-download"></i> <span>Descargar</span>
																			</a>
																		</td>
																	</tr>
