...
<div class="div-crear-acta form" id="div-crear-acta">
		...
		<div class="col-md-12">
			<div class="panel panel-primary">
				<div class="panel-heading">
					ACTA DE SUPERVISI&Oacute;N SEGURIDAD Y SALUD EN EL TRABAJO
				</div>
	...
	<div class="panel panel-primary">
        <div class="panel-heading">
            IMPLEMENTOS DE PROTECCI&Oacute;N PERSONAL / UNIDADES M&Oacute;VILES
        </div>
        <div class="panel-body">
	...
	<div class="row">
		<div class="col-md-12">
			<div class="panel panel-primary">
				<div class="panel-heading">
					RESPONSABLES DE LA SUPERVISI&Oacute;N
				</div>
				<div class="panel-body">
					<div class="table-responsive">
						<table class="table table-striped table-bordered table-hover"
