...
<head>
   ...
   <link href='http://fonts.googleapis.com/css?family=Open+Sans' rel='stylesheet' type='text/css' />
    ...
    <?php if($this->request->controller == 'actas'){?>
    ...
    <?php }else if($this->request->controller == 'acta_medio_ambientes'){?>
		...
		<nav class="navbar navbar-default navbar-cls-top " role="navigation"
			...
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="<?= ENV_WEBROOT_FULL_URL; ?>" style="padding:5px 5px">
					...
					<div style="font-size: 11px;line-height: 14px;font-weight: 100;padding: 5px;">Gesti&oacute;n de Ingeniería y Sostenibilidad empresarial M&M</div>
				</a>
			</div>
			<div
