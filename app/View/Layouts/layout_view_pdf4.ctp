...
<div style='border-style:solid;border-width:1px;'><table class='tg' width='100%'><tr>
			...
			foreach($obj_acta->FotoSupervisionActa as $key => $obj_foto_sup) {
				$codigo.= "<td class='tg-031e' style='vertical-align:middle; text-align:center; border-style: none;'>
							<a target='_blank' href='".ENV_WEBROOT_FULL_URL."files/fotos_acta_supervision/".$obj_foto_sup->getAttr('file_name')."' ><img src='".ENV_WEBROOT_FULL_URL."files/fotos_acta_supervision/".$obj_foto_sup->getAttr('file_name')."' width='680px' height='840px' style='padding:4px'></a></td>";
				$cont++;
				if($cont == 1){
					$codigo.="</tr></table>";
					$codigo.="<table class='tg' width='100%'><tr>";
