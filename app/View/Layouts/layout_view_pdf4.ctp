...
foreach($obj_acta->FotoIpp as $key => $obj_foto_ipp) {
	$codigo.= "<td class='tg-031e' style='vertical-align:middle; text-align:center; border-style: none;'>
			<a target='_blank' href='".ENV_WEBROOT_FULL_URL."files/fotos_ipp/".$obj_foto_ipp->getAttr('file_name')."'><img src='".ENV_WEBROOT_FULL_URL."files/fotos_ipp/thumbnail/".$obj_foto_ipp->getAttr('file_name')."' width='340px' height='280px'></a>
...
foreach($obj_acta->FotoSd as $key => $obj_foto_sd) {
	$codigo.= "<td class='tg-031e' style='vertical-align:middle; text-align:center; border-style: none;'>
				<a target='_blank' href='".ENV_WEBROOT_FULL_URL."files/fotos_sd/".$obj_foto_sd->getAttr('file_name')."'><img src='".ENV_WEBROOT_FULL_URL."files/fotos_sd/thumbnail/".$obj_foto_sd->getAttr('file_name')."' width='340px' height='280px'></a>
...
foreach($obj_acta->FotoUm as $key => $obj_foto_um) {
	$codigo.= "<td class='tg-031e' style='vertical-align:middle; text-align:center; border-style: none;'>
			  <a target='_blank' href='".ENV_WEBROOT_FULL_URL."files/fotos_um/".$obj_foto_um->getAttr('file_name')."'><img src='".ENV_WEBROOT_FULL_URL."files/fotos_um/thumbnail/".$obj_foto_um->getAttr('file_name')."' width='340px' height='280px'></a>
...
foreach($obj_acta->FotoDoc as $key => $obj_foto_doc) {
	$codigo.= "<td class='tg-031e' style='vertical-align:middle; text-align:center; border-style: none;'>
			  <a target='_blank' href='".ENV_WEBROOT_FULL_URL."files/fotos_doc/".$obj_foto_doc->getAttr('file_name')."'><img src='".ENV_WEBROOT_FULL_URL."files/fotos_doc/thumbnail/".$obj_foto_doc->getAttr('file_name')."' width='340px' height='280px'></a>
...
foreach($obj_acta->FotoAct as $key => $obj_foto_as) {
	$codigo.= "<td class='tg-031e' style='vertical-align:middle; text-align:center; border-style: none;'>
				<a target='_blank' href='".ENV_WEBROOT_FULL_URL."files/fotos_as/".$obj_foto_as->getAttr('file_name')."'><img src='".ENV_WEBROOT_FULL_URL."files/fotos_as/thumbnail/".$obj_foto_as->getAttr('file_name')."' width='340px' height='280px'></a>
...
foreach($obj_acta->FotoCond as $key => $obj_foto_cs) {
	$codigo.= "<td class='tg-031e' style='vertical-align:middle; text-align:center; border-style: none;' width='100%'>
				<a target='_blank' href='".ENV_WEBROOT_FULL_URL."files/fotos_cs/".$obj_foto_cs->getAttr('file_name')."'><img src='".ENV_WEBROOT_FULL_URL."files/fotos_cs/thumbnail/".$obj_foto_cs->getAttr('file_name')."' width='340px' height='280px'></a>
		...
		<table class='tg' width='100%'>
		  ...
		  <tr>
			...
			foreach($obj_acta->FotoMed as $key => $obj_foto_med) {
				$codigo.= "<td class='tg-031e' style='vertical-align:middle; text-align:center; border-style: none;'>
							<a target='_blank' href='".ENV_WEBROOT_FULL_URL."files/fotos_med/".$obj_foto_med->getAttr('file_name')."' ><img src='".ENV_WEBROOT_FULL_URL."files/fotos_med/thumbnail/".$obj_foto_med->getAttr('file_name')."' width='340px' height='280px'></a>
