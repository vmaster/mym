...
$codigo.= "<div class='head-pag'>
			<table class='tg tg-031eF back-blue' width='100%'>
			  <tr>
				<th style='width:20%;' class='back-green' ><img src='".ENV_WEBROOT_FULL_URL."img/ensa.png' style='width: 60px; border:0px;'/></th>
...
$codigo .="<table class='tg font-head' width='100%' style='margin-bottom:-10px'>
  ...
  <tr>
    ...
    <th class='tg-031eF aling-left' colspan='3' style='width:43%'>Electronorte S.A.</th>
