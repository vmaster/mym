			...
			<?php if($this->Session->read('Auth.User.consorcio_id') != 2) { ?>
				...
				*/ ?>
				<?php if($this->Session->read('Auth.User.tipo_user_id') != 3) { ?>
					<li><a class="enlaces <?php echo ($this->request->params['controller'] == 'trabajadores')?"active-menu":""; ?>" href="<?= ENV_WEBROOT_FULL_URL; ?>trabajadores/listado_trabajadores" id="link-tarea"><i class="fa fa-file-text fa-3x"></i> <?php echo ' '.__('Tareas de personal'); ?></a></li>
