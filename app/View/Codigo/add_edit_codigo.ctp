	...
	<section>
		<div class="row">
			<div class="span3 col-md-3 col-sm-6 col-xs-6">
				...
				<?php echo $this->Form->input('codigo', array('div' => false, 'label' => false, 'class'=> 'txtCodigo form-control','id' =>'txtCodigo','style'=>'text-transform:uppercase;', 'onkeyup'=>'javascript:this.value=this.value.toUpperCase();')); ?>
			</div>
			<div class="span3 col-md-3 col-sm-6 col-xs-6">
			...
			<div class="span3 col-md-3 col-sm-6 col-xs-6">
				...
				<?php echo $this->Form->input('observacion', array('div' => false, 'label' => false, 'class'=> 'txtObservacion form-control','id' =>'txtObservacion','style'=>'text-transform:uppercase;', 'onkeyup'=>'javascript:this.value=this.value.toUpperCase();')); ?>
			</div>
		</div>
		<p>
		<div class="row">
			<div class="span3 col-md-3 col-sm-6 col-xs-6">
				...
				<?php echo $this->Form->input('norma_incumplida', array('div' => false, 'label' => false, 'class'=> 'txtNorInc form-control','id' =>'txtNorInc','style'=>'text-transform:uppercase;', 'onkeyup'=>'javascript:this.value=this.value.toUpperCase();')); ?>
			</div>
		</div>
		<br>
