...
App::uses('AppModel','Model');
  class ActaMedioAmbiente extends AppModel {
    ...
    public $hasMany = array(
    		...
    		'FotoMedAmbCond' => array(
    				'className' => 'FotoMedAmbCond',
    				'foreignKey' => 'acta_id',
    				'dependent' => false,
    				'conditions' => '',
    				'fields' => '',
            ...
            'FotoMedAmbMedida' => array(
                    'className' => 'FotoMedAmbMedida',
                    'foreignKey' => 'acta_id',
                    'dependent' => false,
                    'conditions' => '',
                    'fields' => '',
    ...
    public function sendReporteEmail($acta_id, $email_destino, $email_copia, $num_informe, $asunto, $mensaje){
    	...
    	$Email->template('medioambiente','send_informe');
