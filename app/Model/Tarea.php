   ...
   public function listAllTareas($order_by='Tarea.created',$order='DESC', $user_id=0) {
    ...
    public function obtenerActividades($tarea_id){
        $arr_obj_tarea = $this->find('all',array(
                    'fields'  => array('Tarea.descripcion','Tarea.created','TrabajadorJoin.apellido_nombre','Tarea.created','Tarea.informe_ref','Tarea.movilidad','Tarea.placa_auto','Tarea.dia_libre'),
                    'joins' => array(
                        array(
                                'table' => 'users',
                                'alias' => 'UsuarioJoin',
